...
export default async function handler(req, res) {
  ...
  try {
    ...
    console.log("Portfolio creation request:", {
      hasSlug: !!portfolioData.slug,
      slug: portfolioData.slug,
      hasLayout: !!portfolioData.layout,
      layout: portfolioData.layout,
      hasTheme: !!portfolioData.theme,
      hasSections: Array.isArray(portfolioData.sections),
      sectionsCount: portfolioData.sections?.length || 0,
    });
    ...
    if (slugAlreadyExists) {
      console.log("Slug already exists, checking ownership:", finalSlug);
      ...
      if (isOwnPortfolio) {
        ...
        console.log("Slug belongs to another user, generating unique slug...");
        let attempts = 0;
        ...
        if (slugWasAutoGenerated) {
          console.log(`Auto-generated unique slug: ${finalSlug} (original: ${slugValidation.slug})`);
        }
      }
    }
